            ...
            if email_test_two != -1: #if find is able to locate a '.' in the correct area
                ...
                while password_check == False:
                    ...
                    if length >= 8: #checks for password length being 8 or more
                        ...
                        if pass_test_one == -1:
                            if pass_test_one == -1 and length >= 8:
                                if pass_test_one == -1:#if no whitespace found
                                    ...
                                    if not re.search("[A-Z]", password): #checks for at least one capitol letter
                                    ...
                                    if not re.search("[!?@#$^&*_-]", password): #checks for at least one of the specified characters
